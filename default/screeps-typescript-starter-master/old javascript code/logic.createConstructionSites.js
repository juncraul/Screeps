...
var logicCreateConstructionSites = {
    run: function() {
        ...
        var flag = Game.flags["CreateSpawn"];
        if(flag != null)
        {
...
var buildExtensionsAlongPath = function(room, startPos, buildAbove, buildBelow) {
    var top = 6;
    for(var i = 1; i <= ((buildAbove && top) || (!buildAbove && top - 1)); i ++)
    {
